...
{
    Age = 42,
    BirthDate = ToDateTime("1977-01-01"),
    Name = "Jack Daniels",
...
p1.Age = 32;
p1.BirthDate = ToDateTime("1900-01-01");
p1.Name = "Frank";
...
{
    WriteLine("      Name: {0:s}, Age: {1:d}, BirthDate: {2:MM/dd/yy}", p.Name, p.Age, p.BirthDate);

    if (p.IdInfo is not null)
    {
        WriteLine("      ID#: {0:d}", p.IdInfo.IdNumber);
    }
}
